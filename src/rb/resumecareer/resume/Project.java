...
public class Project extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bk = (Button) findViewById(R.id.btnProjectBack);

		dbAdapter = new DatabaseAdapter(this);
		dbAdapter.open();

		try {
			listview = (ListView) findViewById(R.id.list_all_project);
			if (idclick1 != 0) {
				ide = idclick1;
				data = dbAdapter.getAllProjectData(idclick1);
			...
			listview.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
					...
					final String itemAt = listview.getItemAtPosition(arg2)
							.toString();
					build = new AlertDialog.Builder(Project.this);
		...
		bk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Project.this,
						ProjectDetails.class);
	...
	protected void onResume() {
		...
		data = dbAdapter.getAllProjectData(ide);
		view = new ArrayList<String>();
		for (int i = 2; i <= data.size(); i = i + 3) {
			view.add(data.get(i));
		}
