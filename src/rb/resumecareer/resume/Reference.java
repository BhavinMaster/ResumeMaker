...
public class Reference extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bk = (Button) findViewById(R.id.btnReferenceAddMore);

		dbAdapter = new DatabaseAdapter(this);
		dbAdapter.open();

		try {
			listview = (ListView) findViewById(R.id.list_all_reference);
			if (idclick1 != 0) {
				ide = idclick1;
				data = dbAdapter.getAllReferenceData(idclick1);
			...
			listview.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
					...
					final String itemAt = listview.getItemAtPosition(arg2)
							.toString();
					build = new AlertDialog.Builder(Reference.this);
		...
		bk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Reference.this,
						ReferenceDetail.class);
	...
	protected void onResume() {
		...
		data = dbAdapter.getAllReferenceData(ide);
		view = new ArrayList<String>();
		for (int i = 2; i <= data.size(); i = i + 3) {
			view.add(data.get(i));
		}
